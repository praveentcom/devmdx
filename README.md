...
Although it's not comprehensive enough to be considered as a perfect portfolio template, it's a good starting point for someone who loves to write markdown and host their articles on their own website and infrastructure. Get started with DevMDX today and if you need assistance, reach out to me via [GitHub](https://github.com/praveentcom/devmdx) or [X](https://x.com/praveentcom).
...
I've used shadcn/ui for setting up the template. This means you can adapt DevMDX to your taste with custom shadcn/ui theming. Refer to [ui.shadcn.com](https://ui.shadcn.com/docs/theming) for more details on how to modify.
...
I've loved crafting this template as an OSS template. Get started today and for assistance, you can reach on [X](https://x.com/praveentcom). You can also shoot PRs on the way if you'd like something added to DevMDX or if there is a bug that's bothering you.
