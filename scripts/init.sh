...
export function serializeProfileData(data: ProfileData): ProfileData {
  return {
    ...data,
...
const rawProfileData: ProfileData = {
  profile: {
    ...
    gender: "${GENDER}",
    email: "${EMAIL}",
    image: "https://placehold.co/256x256/orange/white",
...
export const profileData = serializeProfileData(rawProfileData);
...
# Create some sample community events
